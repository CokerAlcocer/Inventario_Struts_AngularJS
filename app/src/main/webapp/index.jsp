...
<div class="container mt-4">
  <s:if test="categories.size() <= 0 && brands.size() <= 0" >
  ...
  <s:elseif test="categories.size() <= 0">
    <!--ALERTA EN CASO NO HABER NINGÚN REGISTRO-->
    <div class="alert alert-warning">
          ...
          <div class="card mb-4 shadow">
            <div class="row">
              ...
              <div class="col-6 col-lg-12 pl-0 pl-lg-4 mt-0 d-flex flex-fill">
                <div class="card-body">
                  <div class="badge badge-secondary mb-1"><i class="fas fa-circle"></i> <s:property value="categoryId" />
                  </div>
                  <h4><s:property value="name" /></h4>
                  <p>
                    <small><span><strong>Precio: </strong> $<s:property value="price"/></span></small>
                    <br>
                    <small><span><strong>Disponible: </strong> <s:property value="quantity" /> unidades</span></small>
                  </p>
                  <a class="mt-4" ng-click="getInfoBrand(<s:property value="brandId" />)" href="#infoModal" data-toggle="modal">Mas Información</a>
